...
const translations = {
  en: {
    ...
    paymentModeInfo:       'Informative',
    paymentModeTrans:      'Transactional',
    paymentModeDesc:       'Informative: the bot shares payment details and staff confirms manually. Transactional: Stripe auto-confirms the booking after payment.',
    saveMode:              'Save mode',
    stripeConfig:          'Stripe configuration',
    stripeOnline:          'Online card payments',
    publishableKey:        'Publishable key',
    secretKey:             'Secret key',
    webhookSecret:         'Webhook secret',
    webhookSecretOpt:      'optional',
    webhookRegisterAt:     'Register your webhook at',
    saveStripe:            'Save Stripe',
    manualMethods:         'Manual payment methods',
    manualMethodsDesc:     'Bank accounts and wallets',
    noMethodsYet:          'No payment methods configured yet.',
    addMethod:             'Add method',
    methodLabel:           'Label',
    methodLabelPlaceholder:'e.g. Bancolombia Ahorros, Nequi',
    bankName:              'Bank name',
    accountHolder:         'Account holder',
    walletName:            'Wallet name (e.g. Nequi, Daviplata)',
  ...
  es: {
    ...
    paymentModeInfo:       'Informativo',
    paymentModeTrans:      'Transaccional',
    paymentModeDesc:       'Informativo: el bot comparte los datos de pago y el equipo confirma manualmente. Transaccional: Stripe auto-confirma la reserva tras el pago.',
    saveMode:              'Guardar modo',
    stripeConfig:          'Configuración Stripe',
    stripeOnline:          'Pagos con tarjeta online',
    publishableKey:        'Clave pública',
    secretKey:             'Clave secreta',
    webhookSecret:         'Webhook secret',
    webhookSecretOpt:      'opcional',
    webhookRegisterAt:     'Registra tu webhook en',
    saveStripe:            'Guardar Stripe',
    manualMethods:         'Métodos de pago manuales',
    manualMethodsDesc:     'Cuentas bancarias y wallets',
    noMethodsYet:          'Aún no hay métodos de pago configurados.',
    addMethod:             'Agregar método',
    methodLabel:           'Etiqueta',
    methodLabelPlaceholder:'ej. Bancolombia Ahorros, Nequi',
    bankName:              'Nombre del banco',
    accountHolder:         'Titular de la cuenta',
    walletName:            'Nombre del wallet (ej. Nequi, Daviplata)',
