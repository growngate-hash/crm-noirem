...
const T = {
  es: {
    ...
    testimBiz2: 'Next Level Detailing',
    testimCity2: 'Ciudad de México, México',
    ...
    testimName3: 'Ana P.',
    testimBiz3: 'Noirem Car Care',
    testimCity3: 'Dubái, Emiratos Árabes Unidos',
    ...
    testimName4: 'Diego A.',
    testimBiz4: 'AMG Mobile Detailing',
    testimCity4: 'Monterrey, México',
  },
  en: {
    // Nav
    ...
    testimName2: 'Marcos R.',
    testimBiz2: 'Next Level Detailing',
    testimCity2: 'Mexico City, Mexico',
