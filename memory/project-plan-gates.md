...
Sistema de feature gates implementado el 2026-05-30.
...
- `starter`: bloquea `/hr/**` y `/reports`
- `pro`: accede a todo excepto `brandCustomization`
- `enterprise`: acceso completo
- `trial`: acceso completo (10 días)
